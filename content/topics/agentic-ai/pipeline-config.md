# Pipeline Config — Agentic AI

> Topic-scoped pipeline. The orchestrator reads this when run with topic `agentic-ai`
> (e.g. `/topic-pipeline agentic-ai`). Outputs land in this workspace
> (`content/topics/agentic-ai/`). Persistent files: `feed-sources.md`, `idea-queue.md`.
...
| **Output path** | `content/topics/agentic-ai/` |
