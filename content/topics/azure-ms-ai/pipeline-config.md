# Pipeline Config — Azure / Microsoft AI

> Topic-scoped pipeline. The orchestrator reads this when run with topic `azure-ms-ai`
> (e.g. `/topic-pipeline azure-ms-ai`). Outputs land in this workspace
> (`content/topics/azure-ms-ai/`). Persistent files: `feed-sources.md`, `idea-queue.md`.
...
|-------|-------|
| **Status** | `not-started` |
| **Topic** | Azure / Microsoft AI |
| **Topic slug** | `azure-ms-ai` |
| **Output path** | `content/topics/azure-ms-ai/` |
