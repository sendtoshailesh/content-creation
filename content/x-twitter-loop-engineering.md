...
**Attach:** `content/visuals/p1-01-staircase.png` (the four-era staircase) — alt fallback `content/visuals/p2-06-projects-ladder.png`
...
## Optional reply (post immediately after, only if you want the full breakdown linked)
...
**Note:** Keep the primary post as the single deliverable. The reply is optional — use it only if you want the canonical link and the advanced projects surfaced without diluting the hook.
